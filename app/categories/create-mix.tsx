...
export default function CreateMixScreen() {
  ...
  const AVAILABLE_CATEGORIES: Category[] = [
    ...
    { title: 'Morning vibes', value: 'morning-vibes', icon: 'sunny' },
    { title: 'Energy', value: 'energy', icon: 'flash' },
    { title: 'Motivation', value: 'motivation', icon: 'trending-up' },
    { title: 'Self-care', value: 'self-care', icon: 'flower' },
    { title: 'Mindfulness', value: 'mindfulness', icon: 'leaf' },
    { title: 'Sleep & rest', value: 'sleep-rest', icon: 'moon' },
    { title: 'Stress relief', value: 'stress-relief', icon: 'happy' },
    { title: 'Anxiety', value: 'anxiety', icon: 'pulse' },
    { title: 'Focus', value: 'focus', icon: 'telescope' },
    { title: 'Overthinking', value: 'overthinking', icon: 'infinite' },
    { title: 'Peace', value: 'peace', icon: 'flower-outline' },
    { title: 'Gratitude', value: 'gratitude', icon: 'heart-circle' },
    { title: 'Confidence', value: 'confidence', icon: 'star' },
    { title: 'Growth', value: 'growth', icon: 'leaf' },
    { title: 'Boundaries', value: 'boundaries', icon: 'shield-checkmark' },
    { title: 'Relationships', value: 'relationships', icon: 'people' },
    { title: 'Change', value: 'change', icon: 'leaf' },
  ];
